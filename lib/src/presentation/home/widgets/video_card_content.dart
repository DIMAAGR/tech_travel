...
class VideoCardContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return movieEntity != null && !isLoading
        ? Column(
            ...
            children: [
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(movieEntity!.genre, style: AppTextStyle.subtitle2),
                    const SizedBox(height: 4),
                    Text(movieEntity!.title, style: AppTextStyle.h1.copyWith(fontSize: 32)),
                    const SizedBox(height: 4),
                    SizedBox(
                      width: 248,
                      child: Text(movieEntity!.description, style: AppTextStyle.subtitle3),
                    ),
                    const SizedBox(height: 24),
                    Text(
                      'Comments ${movieEntity!.commentsCount.toThousands()}',
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(movieEntity!.releaseDate.toShortFormatted(), style: AppTextStyle.labelMedium),
                      ],
                    )
                  ],
                ),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _loadingShimmer(height: 16, width: MediaQuery.of(context).size.width - 128),
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        _loadingShimmer(height: 12, width: MediaQuery.of(context).size.width - 156),
                      ],
                    ),
                    const SizedBox(height: 32),
                    Stack(
                      ...
                      children: [
                        ...
                        Positioned(
                          right: 36,
                          child: _loadingShimmer(height: 16, width: MediaQuery.of(context).size.width - 212),
                        ),
                      ],
                    ),
                  ],
